...
[Icons]
Name: "{group}\HomeGenie 1.1 beta (r522)"; Filename: "{app}\HomeGenieManager.exe"
Name: "{group}\Uninstall HomeGenie 1.1 beta (r522)"; Filename: "{uninstallexe}"
