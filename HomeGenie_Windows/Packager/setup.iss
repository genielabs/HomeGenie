...
[Setup]
AppName=HomeGenie
AppVerName=HomeGenie 1.00 beta (r491)
AppPublisher=GenieLabs
AppPublisherURL=http://www.homegenie.it
AppVersion=1.00 beta (r491)
...
[Icons]
Name: "{group}\HomeGenie 1.00 beta (r491)"; Filename: "{app}\HomeGenieManager.exe"
Name: "{group}\Uninstall HomeGenie 1.00 beta (r491)"; Filename: "{uninstallexe}"
