...
Source: ".\Drivers\USB_ActiveHome_Interface\*"; DestDir: "{app}\Drivers\LibUsb_CM15_CM19"; Flags: ignoreversion recursesubdirs
...
Filename: "{app}\Drivers\LibUsb_CM15_CM19\InstallDriver.exe"; WorkingDir: "{app}"; Flags: hidewizard; Description: "X10 driver install"; StatusMsg: "Installing X10 driver"
