...
[Setup]
AppName=HomeGenie
AppVerName=HomeGenie 1.00 beta (r474)
AppPublisher=GenieLabs
AppPublisherURL=http://www.homegenie.it
AppVersion=1.00 beta (r474)
...
[Icons]
Name: "{group}\HomeGenie 1.00 beta (r474)"; Filename: "{app}\HomeGenieManager.exe"
Name: "{group}\Uninstall HomeGenie 1.00 beta (r474)"; Filename: "{uninstallexe}"
