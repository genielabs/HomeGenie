...
```bash
wget https://sourceforge.net/projects/homegenie/files/homegenie-beta_1.1.r496_all.deb/download
sudo apt-get update
sudo apt-get install gdebi-core
sudo gdebi homegenie-beta_1.1.r496_all.deb
```
...
```bash
wget https://sourceforge.net/projects/homegenie/files/homegenie_1_1_beta_r496.tgz/download
tar xzvf HomeGenie_1_1_beta_r496.tgz
```
